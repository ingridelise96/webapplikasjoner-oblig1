...
try {
  ...
  /// Rest parameter ///
	...
	(function UseRestParameter() {
		...
		function foo(a, b, ... c) {
			//const [first, second, third=3, fourth=4] = c;
			//const [ one, two, ... restNumbers ] = c;
			return a + b + c.length;
		}
  ...
  /// Object Spread Properties (ES2018) ///
	...
	(function UseObjectSpreadProperties2() {
		...
		let result = { a: obj1.a, b: obj2.b, c: obj3.c, ... obj2 };
