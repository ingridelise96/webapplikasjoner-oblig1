...
let completedTodoObjects = [
    ...
    {title: "Get dinners", 
    author: "Ingrid E. Dahl",
    description: "Buy all dinners for this week at Rema 1000.", 
    date: testDate2},
...
let newTodoModal = document.getElementsByClassName('modalOverlay')[0];
let newTodoBtn = document.getElementById('newTodoBtn');
let closeModalIcon = document.getElementsByClassName('iconClose')[0];
let createTodoBtn = document.getElementById('createTodoBtn');
let descriptionTxt = document.getElementById('description');
let todoCards = document.getElementsByClassName('todoCards')[0];
let card = document.getElementsByClassName('card');
let filterNewChk = document.getElementById('filterNew');
let filterOldChk = document.getElementById('filterOld');
...
createTodo = () => {
    let newTodoTitle = document.getElementById('title').value;
    let newTodoDescription = document.getElementById('description').value;
    let newTodoAuthor = document.getElementById('author').value;
...
charCounter = () => {
    ...
    let showAvail = document.getElementById('availChars');
...
sortByNew = () => {
    ...
    fillTable();
    document.getElementById('filterOld').checked = false;
}
